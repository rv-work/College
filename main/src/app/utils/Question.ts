    ...
    Medium: [
      {
        ...
        cases: [
          ...
          },
          {
            ...
            output: "6",
            explanation: "After removing duplicates such that each unique element appears at most twice, nums becomes [1,1,2,2,3,3] and the length of the resulting array is 6."
          }
        ],
        templateCode: {
          Python: "from typing import List\n\ndef removeDuplicates(nums: List[int]) -> int:\n    # Code goes here",
      ...
      },
      {
        ...
        cases: [
          {
            caseNumber: 1,
            input: ["operations", "[\"RandomizedSet\", \"insert\", \"remove\", \"insert\", \"getRandom\", \"remove\", \"insert\", \"getRandom\"]", "values", "[[], [1], [2], [2], [], [1], [2], []]"],
            output: "[null, true, false, true, 2, true, false, 2]"
          },
          {
            caseNumber: 2,
            input: ["operations", "[\"RandomizedSet\", \"insert\", \"insert\", \"getRandom\"]", "values", "[[], [1], [2], []]"],
      ...
      },
      {
        ...
        cases: [
          ...
          },
          {
            ...
            output: "[0,0,9,0,0]",
            explanation: "Since there's a zero in the array, all products except the one at zero's position will be zero."
          },
          {
            caseNumber: 3,
            input: ["nums", "[1,1]"],
      ...
      },
      {
        ...
        cases: [
          ...
          },
          {
            ...
            output: "4",
            explanation: "Starting from station 4, the car can complete the circuit."
          }
        ],
        templateCode: {
    ...
    Hard: [
      {
        ...
        cases: [
          ...
          },
          {
            ...
            output: "7",
            explanation: "You can allocate to the children with [1,2,1,2,1] candies respectively."
          }
        ],
        templateCode: {
      ...
      },
      {
        ...
        cases: [
          ...
          },
          {
            ...
            output: "9",
            explanation: "The trapped water forms between the elevation bars."
          },
          {
            caseNumber: 3,
          ...
          cases: [
            {
              ...
              explanation: "The string is converted to zigzag pattern with 3 rows."
            },
            {
              caseNumber: 2,
              input: ["s", "\"PAYPALISHIRING\"", "numRows", "4"],
              output: "\"PINALSIGYAHRPI\"",
              explanation: "The string is converted to zigzag pattern with 4 rows."
            },
            {
              caseNumber: 3,
              input: ["s", "\"A\"", "numRows", "1"],
          ...
          cases: [
            {
              ...
              explanation: "Lines are justified to exactly 16 characters with spaces distributed evenly."
            },
            {
              caseNumber: 2,
              input: ["words", "[\"What\",\"must\",\"be\",\"acknowledgment\",\"shall\",\"be\"]", "maxWidth", "16"],
              output: "[\"What   must   be\", \"acknowledgment  \", \"shall be        \"]",
              explanation: "Note that the last line \"shall be    \" instead of \"shall     be\", because the last line must be left-justified instead of fully-justified."
            },
            {
              caseNumber: 3,
        ...
        },
        {
          ...
          cases: [
            ...
            },
            {
              ...
              output: "false",
              explanation: "\"axc\" cannot be formed as a subsequence of \"ahbgdc\"."
            },
            {
              caseNumber: 3,
              input: ["s", "\"\"", "t", "\"ahbgdc\""],
      ...
      Medium: [
        {
          ...
          cases: [
            ...
            },
            {
              ...
              output: "16",
              explanation: "The maximum water that can be contained is between the first and last line."
            }
          ],
          templateCode: {
