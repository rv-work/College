...
const Page = () => {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("pdfQuizResult");
    if (stored) {
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#030711] to-[#0f172a] text-white p-4">
        <div className="w-full max-w-4xl p-8 rounded-2xl bg-[#111827]/90 backdrop-blur-sm shadow-2xl border border-blue-500/20">
          ...
          <div className="flex justify-center">
            <button
              onClick={() => router.push("/tools/pdf-quiz")}
      ...
      <div className="w-full p-4 rounded-2xl bg-[#111827]/90 backdrop-blur-sm shadow-2xl border border-blue-500/20 animate-fadeIn">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/2">
            <div
              className={`p-6 rounded-xl border flex flex-col ${isSkipped
            ...
            >
              <div className="flex items-center justify-between mb-5">
                ...
                <div
                  className={`px-3 py-1 rounded-full text-sm font-medium ${isSkipped
                ...
                <div className="space-y-4 mb-6">
                  {currentQuestion.options.map((option, oIndex) => {
                    ...
                    return (
                      <div
                        key={oIndex}
                        className={`p-4 rounded-lg flex items-center border ${isCorrectAnswer
              ...
              <div className="pt-6 mt-auto flex justify-between">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-bold transition-all ${currentQuestionIndex === 0
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-bold transition-all ${currentQuestionIndex === result.questions.length - 1
                      ? "bg-gray-700/50 text-gray-500 cursor-not-allowed"
                      : "bg-blue-700 hover:bg-blue-600 transform hover:scale-105 active:scale-95"
                    }`}
                >
            ...
            {result.questions.map((_, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full aspect-square rounded-lg flex items-center justify-center text-lg font-medium transition-all ${currentQuestionIndex === index
